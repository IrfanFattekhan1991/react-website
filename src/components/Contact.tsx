const Contact = () => {
  return (
    <>
      <section className=" flex justify-center bg-white py-20 lg:py-[90px] overflow-hidden relative z-10">
              ...
              <div className="mb-12 max-w-[570px] lg:mb-0">
                ...
                <div className="mb-8 flex w-full max-w-[370px]">
                  ...
                  <div className="w-full">
                    ...
                    <p className="text-base text-body-color">Pune</p>
                  </div>
                </div>
                <div className="mb-8 flex w-full max-w-[370px]">
                  <div className="mr-6 flex h-[60px] w-full max-w-[60px] items-center justify-center overflow-hidden rounded bg-primary bg-opacity-5 text-primary sm:h-[70px] sm:max-w-[70px]">
                  ...
                  <div className="w-full">
                    ...
                    <p className="text-base text-body-color">123456789</p>
                  </div>
                </div>
                <div className="mb-8 flex w-full max-w-[370px]">
                  <div className="mr-6 flex h-[60px] w-full max-w-[60px] items-center justify-center overflow-hidden rounded bg-primary bg-opacity-5 text-primary sm:h-[70px] sm:max-w-[70px]">
            ...
            <div className="w-full px-4 lg:w-1/2 xl:w-5/12">
              <div className="relative p-8 bg-white rounded-lg shadow-lg sm:p-12">
                <form className="flex flex-col">
                  <input
                    className="border border-solid p-4 m-4 rounded-lg"
                    type="text"
                    name="name"
                  ...
                  <div>
                    <button
                      type="submit"
                      className=" w-full p-4 text-white  border rounded border-primary bg-primary bg-sky-600"
                    >
                      Send Message
                    </button>
                  </div>
